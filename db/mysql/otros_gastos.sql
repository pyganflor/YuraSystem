...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2020 a las 14:54:43
...
CREATE TABLE `otros_gastos` (
  `id_otros_gastos` int(11) NOT NULL,
  `id_area` int(11) NOT NULL,
  `codigo_semana` int(4) NOT NULL,
  `gip` float NOT NULL DEFAULT '0',
...
ALTER TABLE `otros_gastos`
  ADD PRIMARY KEY (`id_otros_gastos`);
...
--
ALTER TABLE `otros_gastos`
  MODIFY `id_otros_gastos` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
