...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2019 a las 18:29:35
...
(1, 'Cargo Express', 'CEX', 1, '2019-02-08 16:38:54'),
(2, 'Aero Varadero', 'AEV', 1, '2019-02-14 13:08:24');
...
(1, 'Copa', 'A', 1, '2019-02-08 21:46:39');
...
(1, 'MODULO', 2, '2019-03-07 10:48:18', 'I', 1, '127.0.0.1', 'INSERCIÓN SATISFACTORIA DE UN NUEVO MÓDULO'),
(2, 'COSECHA', 1, '2019-03-07 12:06:54', 'I', 1, '127.0.0.1', 'MODIFICACION EN LA TABLA COSECHA');
...
CREATE TABLE `clasificacion_unitaria` (
  ...
  `ramos_x_balde` int(11) NOT NULL DEFAULT '5'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `clasificacion_unitaria` (`id_clasificacion_unitaria`, `nombre`, `fecha_registro`, `estado`, `id_configuracion_empresa`, `id_unidad_medida`, `id_clasificacion_ramo_estandar`, `id_clasificacion_ramo_real`, `tallos_x_ramo`, `color`, `ramos_x_balde`) VALUES
(3, '15|16.6', '2019-02-08 16:27:26', 1, 1, 2, 1, 1, 20, '#ffffff|#000000', 4),
(4, '30|8.3', '2019-02-19 10:39:20', 1, 1, 2, 1, 1, 5, '#00ff00|#000000', 12),
(5, '40|6.25', '2019-02-26 14:57:20', 1, 1, 2, 1, 2, 5, '#ff0000|#ffffff', 10),
(6, '50|5', '2019-02-26 14:57:20', 1, 1, 2, 1, 2, 5, '#0000ff|#ffffff', 7),
(7, '20|12.5', '2019-02-26 14:57:21', 1, 1, 2, 1, 1, 12, '#ffffff|#000000', 6);
...
(1, 1, 1, 1, '2019-02-08 16:54:25'),
(2, 1, 2, 1, '2019-02-14 13:08:39');
...
--
-- Volcado de datos para la tabla `codigo_dae`
--

INSERT INTO `codigo_dae` (`id_codigo_dae`, `codigo_pais`, `dae`, `codigo_dae`, `mes`, `anno`, `estado`, `fecha_registro`) VALUES
(1, 'US', '654', '9875462855', '02', '2019', 1, '2019-02-08 17:01:15');
...
CREATE TABLE `configuracion_empresa` (
  ...
  `baldes_x_coche` int(11) NOT NULL DEFAULT '10'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `configuracion_empresa` (`id_configuracion_empresa`, `nombre`, `cantidad_usuarios`, `cantidad_hectareas`, `propagacion`, `campo`, `postcocecha`, `fecha_registro`, `estado`, `moneda`, `ramos_x_caja`, `razon_social`, `direccion_matriz`, `codigo_pais`, `direccion_establecimiento`, `baldes_x_coche`) VALUES
(1, 'Pyganflor', 5, '15000.00', '||', '|', 'Cosecha|Clasificación en verde|Apertura|Clasificación en blanco|Frío', '2018-11-07 08:46:29', 1, 'usd', 40, 'Pyganflor S.A.', 'Pasaje La Paz E-901 y Ave. 6 de Diciembre', 'EC', 'Vía San José de Minas, Vía al Pisque', 10);
...
INSERT INTO `cosecha` (`id_cosecha`, `fecha_ingreso`, `personal`, `hora_inicio`, `estado`, `fecha_registro`) VALUES
(1, '2019-03-07', 40, '07:00', 1, '2019-03-07 12:06:54');
...
INSERT INTO `desglose_recepcion` (`id_desglose_recepcion`, `id_variedad`, `id_recepcion`, `fecha_registro`, `estado`, `cantidad_mallas`, `tallos_x_malla`, `id_modulo`) VALUES
(1, 2, 1, '2019-03-07 12:06:55', 1, 23, 30, 1),
(2, 1, 1, '2019-03-07 12:06:55', 1, 24, 40, 2);
...
INSERT INTO `detalle_cliente` (`id_detalle_cliente`, `nombre`, `direccion`, `provincia`, `codigo_pais`, `telefono`, `ruc`, `correo`, `fecha_registro`, `estado`, `id_cliente`, `codigo_identificacion`, `codigo_impuesto`, `codigo_porcentaje_impuesto`) VALUES
(1, 'Flower Express', 'Miami', 'Florida', 'US', '0987598413244', '98745687', 'copa@copa.com', '2019-02-08 16:47:50', 1, 1, '08', 2, '7');
...
(2, 'Bounche', 1, 1, '2019-02-08 16:53:32', 'P'),
(3, 'Papel Blanco', 1, 1, '2019-02-08 16:53:32', 'P');
...
(2, '2', 1, '2019-03-07 10:48:18', NULL, '', 1);
...
(1, 1, 1, 15, 1, '2019-02-08 16:34:45'),
(2, 3, 1, 13, 1, '2019-02-08 16:34:59'),
(3, 2, 1, 18, 1, '2019-02-08 16:35:14');
...
INSERT INTO `recepcion` (`id_recepcion`, `id_semana`, `fecha_ingreso`, `fecha_registro`, `estado`, `id_cosecha`) VALUES
(1, 10, '2019-03-07 12:06:00', '2019-03-07 12:06:55', 1, 1);
...
(29, 'Precios', '2019-03-07 09:09:12', 'A', 10, 'precio');
...
(1, 'RAFAEL PRATS RECASEN', 'prats@pyganflor.com', 'rprats', '$2y$10$EQdvjE1T2lQDOICvTtSEB.KtLIW7GheK3HoqzBqiEpMdvYnbGVw8y', 1, '2018-10-02 10:50:24', 'A', 'imagen_perfil_2018_10_10_15_22_32-rprats.jpg', '001'),
...
INSERT INTO `variedad` (`id_variedad`, `nombre`, `siglas`, `minimo_apertura`, `maximo_apertura`, `fecha_registro`, `estado`, `id_planta`, `estandar_apertura`, `tallos_x_malla`, `color`) VALUES
(1, 'GALAXY', 'GLX', 5, 9, '2018-10-25 09:01:47', 1, 1, 7, 50, '#00ff00'),
(2, 'XLENCE', 'XL', 5, 9, '2018-10-25 09:02:30', 1, 1, 7, 30, '#ff8000'),
(3, 'MILLION STAR', 'MS', 3, 10, '2018-10-25 09:03:46', 1, 1, 7, 50, '#8080ff');
...
--
ALTER TABLE `cliente_agenciacarga`
  MODIFY `id_cliente_agencia_carga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `codigo_dae`
  MODIFY `id_codigo_dae` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `cosecha`
  MODIFY `id_cosecha` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `empaque`
  MODIFY `id_empaque` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `rol_submenu`
  MODIFY `id_rol_submenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
