...
class TipoIdentificacionController extends Controller
{
    ...
    public function buscar_tipo_identificacion(Request $request){
        ...
        return view('adminlte.gestion.facturacion.tipo_identificacion.partials.listado', $datos);
    }

    public function add_tipo_identificacion(Request $request){
        return view('adminlte.gestion.facturacion.tipo_identificacion.form.add_tipo_identificacion',[
