...
class YuraController extends Controller
{
    ...
    public function select_filtro_variedad(Request $request)
    {
        ...
        return view('adminlte.partials.dashboard_x_variedad', [
            'variedad' => $variedad,
            'calibre' => getIndicadorByName('D1')->getVariedad($variedad->id_variedad)->valor,
            'tallos' => getIndicadorByName('D2')->getVariedad($variedad->id_variedad)->valor,
            'precio_x_ramo' => getIndicadorByName('D3')->getVariedad($variedad->id_variedad)->valor,
            'precio_x_tallo' => getIndicadorByName('D14')->getVariedad($variedad->id_variedad)->valor,
            'valor' => getIndicadorByName('D4')->getVariedad($variedad->id_variedad)->valor,
            'rendimiento' => getIndicadorByName('D5')->valor,
            'desecho' => getIndicadorByName('D6')->valor,
            'area_produccion' => getIndicadorByName('D7')->getVariedad($variedad->id_variedad)->valor,
