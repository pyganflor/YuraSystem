...
class DocumentosElectronicosAgenciaCarga extends Mailable
{
    ...
    public function build()
    {
        ...
        $correo = $this->from($this->correoEmpresa)
            ->view('adminlte.gestion.mails.documento_electronico_agencia_carga')
            ->subject($inicialesEmpresa." - FACT Agencia ".$this->comprobante->secuencial." ". $this->comprobante->envio->pedido->cliente->detalle()->nombre);;
        ...
        $correo->with(['comprobante'=>$this->comprobante]);
