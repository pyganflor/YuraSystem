<div class="nav-tabs-custom" style="cursor: move;">
    ...
    <div class="tab-content no-padding">
        <div class="chart tab-pane active" id="cosecha-chart" style="position: relative">
            <canvas id="chart_data_desechos" width="100%" height="40" style="margin-top: 5px"></canvas>
        </div>
            ...
            <table class="table-striped table-responsive table-bordered" width="100%" style="border: 2px solid #9d9d9d;">
                ...
                @foreach($arreglo_variedades as $v)
                    ...
                    <tr>
                        ...
                        @foreach($v['desecho'] as $pos => $valor)
...
<script>
    construir_char_acumulado('Desechos', 'chart_data_desechos');
    ...
    function construir_char_acumulado(label, id) {
        ...
        @endfor
            ...
            data_list = [];
        @foreach($variedad['desecho'] as $desechos)
        data_list.push("{{$desechos}}");
        @endforeach
