        ...
        <div style="overflow-x: scroll">
            <table class="table-responsive" width="100%">
                ...
                <tr>
                    ...
                    <th class="text-center">{{number_format($costos_cosecha_x_tallo, 4)}}</th>
                    <th class="text-center">{{number_format($costos_postcosecha_x_tallo, 4)}}</th>
                    <th class="text-center">{{number_format($costos_total_x_tallo, 4)}}</th>
                </tr>
            </table>
        </div>
    </div>
...
<script>
    ...
    render_gauge('canvas_cosecha_x_tallo', '{{number_format($costos_cosecha_x_tallo, 4)}}', rangos_costos_cosecha_tallo, true);
    render_gauge('canvas_postcosecha_x_tallo', '{{number_format($costos_postcosecha_x_tallo, 4)}}', rangos_costos_postcosecha_tallo, true);
    render_gauge('canvas_total_x_tallo', '{{number_format($costos_total_x_tallo, 4)}}', rangos_costos_total_tallo, true);
</script>