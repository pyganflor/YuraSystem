                            ...
                            function drawChartOrg() {
                                ...
                                data.addRows([
                                    ...
                                    [{
                                        ...
                                        '<br><strong title="Cosecha x Tallo" style="color:{{$color_9}}"><small>Cosecha x Tallo: </small><span id="span_costos_cosecha_tallo">¢{{number_format($costos_cosecha_x_tallo * 100, 4)}}</span></strong>' +
                                        '<br><strong title="Postcosecha x Tallo" style="color:{{$color_10}}"><small>Postcosecha x Tallo: </small><span id="span_costos_postcosecha_tallo">¢{{number_format($costos_postcosecha_x_tallo *100, 4)}}</span></strong>' +
                                        '<br><strong title="Total x Tallo" style="color:{{$color_11}}"><small>Total x Tallo: </small><span id="span_costos_total_tallo">¢{{number_format($costos_total_x_tallo * 100, 4)}}</span></strong>' +
