<div class="row">
        ...
        <div class="form-group input-group">
            ...
            <select id="codigo_pais_empresa_facturacion" name="codigo_pais_empresa_facturacion" class="form-control">
                @foreach($paises as $pais)
                    <option {{ ($config_empresa_facturacion->codigo_pais == $pais->codigo) ? "selected" : "" }} value="{{$pais->codigo}}">{{$pais->nombre}}</option>
                @endforeach
            </select>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group input-group">
            ...
            <select class="form-control" id="moneda_empresa_facturacion" onchange="icono_moneda_empresa_facturacion()">
    ...
    <div class="col-md-12 text-center">
        <button class="btn btn-primary" onclick="store_configuracion_empresa_factura('{{isset($config_empresa_facturacion->id_configuracion_empresa) ? $config_empresa_facturacion->id_configuracion_empresa : "" }}')">
