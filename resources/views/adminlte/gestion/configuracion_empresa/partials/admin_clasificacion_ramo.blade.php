			...
			@foreach($ramos as $ramo)
				<tr>
					<td class="text-center" style="border-color: #9d9d9d">
						<input type="number" onkeypress="return isNumber(event)" required id="nombre_{{$ramo->id_clasificacion_ramo}}" name="nombre_{{$ramo->id_clasificacion_ramo}}" value="{{$ramo->nombre}}" class="text-center">
					</td>
					<td class="text-center" style="border-color: #9d9d9d">
						<select id="id_unidad_medida_{{$ramo->id_clasificacion_ramo}}" 
