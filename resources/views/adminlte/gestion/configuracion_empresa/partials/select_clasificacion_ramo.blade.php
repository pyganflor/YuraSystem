<select name="id_clasificacion_ramo_{{$campo}}_{{$unitaria->id_clasificacion_unitaria}}" id="id_clasificacion_ramo_{{$campo}}_{{$unitaria->id_clasificacion_unitaria}}" required>
