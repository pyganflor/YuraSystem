            ...
            <form id="form_envios_{{$i+1}}">
                ...
                <div class="box box-solid box-primary">
                    <div class="box-header with-border">
                        <div class="box-title col-md-4" style="margin-top: 5px;"><b>Envío N#:</b>
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="agencia_transporte" name="agencia_transporte" class="form-control"
                                                        {{$facturado != 0 ? "disabled='disabled'" : ""}} required>
                                                    @if(getEnvio($envio->id_envio)->detalles[0]->id_agencia_transporte == null)
                                                        <option selected disabled value="">Seleccione</option>
                                                    @endif
                                                    @foreach($agenciasTransporte as $at)
                                                        <option {!! getEnvio($envio->id_envio)->detalles[0]->id_agencia_transporte ==  $at->id_agencia_transporte ? "selected" : ""!!} value="{{$at->id_agencia_transporte}}">{{$at->nombre}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                    ...
                    <div class="box-footer" style="background: #d2d6de;">
                        ...
                        @if(!empty(getUsuario(session::get('id_usuario'))->punto_acceso) && $envio->confirmado)
                            <button type="button" class="btn btn-success" onclick="genera_comprobante_cliente('{{$envio->id_envio}}','form_envios_{{$i+1}}')">
