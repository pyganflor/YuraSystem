...
@section('contenido')
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body" id="div_content_marcas">
                <table width="100%">
                    <tr>
                        <td>
                            <div class="form-group input-group" style="padding: 0px">
                                <input type="text" class="form-control" placeholder="Búsqueda" id="busqueda_marcas"
                                       name="busqueda_marcas">
...
@section('script_final')
    @include('adminlte.gestion.postcocecha.marcas.script')
@endsection
