        ...
        <table width="100%" class="table-responsive table-bordered" style="font-size: 0.8em; border-color: #9d9d9d" id="table_content_etiqueta">
            ...
            @foreach($facturas as $x => $item)
                ...
                <tr onmouseover="$(this).css('background-color','#add8e6')" onmouseleave="$(this).css('background-color','')">
                    <td style="border-color: #9d9d9d" class="text-center">{{$comprobante->numero_comprobante}}{{$comprobante->fecha_emision}}</td>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="selected_{{$x+1}}" value="{{$item->id_comprobante}}" id="selected_{{$x+1}}">
                                </td>
                                @endif
                                @if($half)
                                <td>
