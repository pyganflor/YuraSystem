...
<head>
    ...
    <link href="{{url('vendor/datatables/css/dataTables.bootstrap.css')}}" rel="stylesheet" type="text/css">
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018-2019 Yura</strong> All rights
        reserved.
    </footer>
...
<script src="{{url('vendor/datatables-plugins/dataTables.bootstrap.min.js')}}" type="text/javascript"></script>
<script src="{{url('vendor/datatables-responsive/dataTables.responsive.js')}}" type="text/javascript"></script>
...
<script>
    ...
    setInterval('buscar_notificaciones("S")', 300000);
